 ...
 */
define(['./vendor/emmet/lib/utils/common',
        './vendor/emmet/lib/utils/action',
        './vendor/emmet/lib/assets/resources',
        './vendor/emmet/lib/assets/tabStops'], function(utils, actionUtils, res, tabStops) {
	/**
